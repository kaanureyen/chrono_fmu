...
class FmuComponent : public chrono::fmi2::FmuChronoComponentBase {
  ...
  private:
    ...
    std::shared_ptr<chrono::vehicle::ChSteeringController> steeringController;  ///< steering controller
    ...
    double stanley_dead_zone; ///< dead zone for Stanley controller
    double max_wheel_turn_angle; ///< max turn angle of wheels for Stanley controller
